...
$sql = "INSERT INTO bookings (childName ,childAge ,servicetype, durationSTART , durationEND , sitterid, parentid , Date_of_booking) VALUES ('$name' , '$age' , '$service' , '$start' , '$end' , '$sitterid' , '$var2' , '$date')";
