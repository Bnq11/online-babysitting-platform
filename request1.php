...
if(false){header("location:signInS.php"); exit();}
          ...
          <div class="sidebar">
              <div class="profile1">
                ...
                <ul>
                    ...
                    <li>
                        <a href="request list.php"class="active">
...
$sql = "SELECT * FROM bookings WHERE bookingID= '1'" ;
            ...
            <h1 class="offer">Request Details</h1>



 <p>

 <strong>Kid's Name:</strong><?php echo $user['childName'] ;   ?> <br>
 <strong>Kid/s Age:</strong>  <?php echo $user['childAge'];   ?> Years old   <br>
 <strong>Type of service:   <?php echo $user['servicetype'];   ?>  </strong>
 <!-- <ul><li>Infant babysitting.</li> <li>Helping the baby eat his meals</li></ul> -->
 <br><strong>Duration: </strong> 
 <?php
 
//  $s_time= strtotime($user['durationSTART']);
          
        //   $e_time= strtotime($user['durationEND']);
          
          
          
          echo "From ". $user['durationSTART'] ." to ".$user['durationEND'] ;
          
          ?>

 </p>
 <p>
<label><strong>Send offer(Price)</strong><input type="text"  name="Accept"> SR.</label><br>
<a href="request List.html"><button class="buttons">Send </button> </a>

<a href="request List.html"><button class="buttons">Cancel </button> </a>
</p></div>
